  ...
  constructor(props) {
    ...
    image = "";
        if (this.props.source) {
          ...
          image = LogInformation.names[this.props.name];
        }
   ...
   _share = () => {  
        ...
        Share.open(shareOptions).then(function(success, activityType) {
            ...
            console.log('You decided to not share');   
            throw error;
  ...
  render() {
    return (
       ...
       <View style={styles.smallColumn}>
        {this.props.source &&
        <TouchableOpacity onPress= {() => {this._goToEntry({
      ...
      'date': this.props.date,
         ...
         <Image source={this.props.uri} style={styles.sourceImage} />
        </TouchableOpacity>
       }
       </View>
